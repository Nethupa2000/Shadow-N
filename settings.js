...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "sihara.max@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "nyTceq-5zonky-ryfmik" : process.env.SEEDER_PASSWORD,
